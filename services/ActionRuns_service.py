...
def post_v1actionsaction_identifierruns(
...
def patch_v1actionsrunsrun_idapproval(
    run_id: str, data: Dict[str, Any], version: Optional[str] = None, api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def get_v1actionsrunsrun_idlogs(
    run_id: str,
    limit: Optional[float] = None,
...
def post_v1actionsrunsrun_idlogs(
...
def post_v1blueprintsblueprint_identifierentitiesentity_identifieractionsaction_identifierruns(
    action_identifier: str,
...
def post_v1blueprintsblueprint_identifieractionsaction_identifierruns(
    action_identifier: str,
    blueprint_identifier: str,
    data: Dict[str, Any],
    run_as: Optional[str] = None,
...
def get_v1actionsrunsrun_idapprovers(
