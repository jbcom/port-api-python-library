...
async def get_v1sidebarsidentifier(identifier: str, api_config_override: Optional[APIConfig] = None) -> None:
...
async def post_v1sidebarssidebar_identifierfolders(
...
async def delete_v1sidebarssidebar_identifierfoldersfolder_identifier(
...
async def patch_v1sidebarssidebar_identifierfoldersfolder_identifier(
