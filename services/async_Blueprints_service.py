...
async def get_v1blueprintsblueprint_identifierpermissions(
...
async def patch_v1blueprintsblueprint_identifierpermissions(
...
async def get_v1blueprints(api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def get_v1blueprintsidentifier(identifier: str, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def put_v1blueprintsidentifier(
...
async def delete_v1blueprintsidentifier(
...
async def patch_v1blueprintsidentifier(
    identifier: str, data: Dict[str, Any], api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
async def patch_v1blueprintsidentifierpropertiesproperty_namerename(
...
async def patch_v1blueprintsidentifiermirrormirror_namerename(
...
async def patch_v1blueprintsidentifierrelationsrelation_identifierrename(
...
async def post_v1blueprintssystemuser_and_team(api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
