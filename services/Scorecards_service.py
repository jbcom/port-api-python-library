...
def get_v1blueprintsblueprint_identifierscorecards(
...
def post_v1blueprintsblueprint_identifierscorecards(
...
def put_v1blueprintsblueprint_identifierscorecards(
...
def get_v1blueprintsblueprint_identifierscorecardsscorecard_identifier(
...
def put_v1blueprintsblueprint_identifierscorecardsscorecard_identifier(
...
def delete_v1blueprintsblueprint_identifierscorecardsscorecard_identifier(
    scorecard_identifier: str, blueprint_identifier: str, api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def get_v1scorecards(api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
