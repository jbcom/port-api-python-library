...
def post_v1actions(data: Dict[str, Any], api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def get_v1actionsaction_identifier(action_identifier: str, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def put_v1actionsaction_identifier(
...
def delete_v1actionsaction_identifier(action_identifier: str, api_config_override: Optional[APIConfig] = None) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def get_v1blueprintsblueprint_identifieractions(
...
def post_v1blueprintsblueprint_identifieractions(
...
def put_v1blueprintsblueprint_identifieractions(
...
def get_v1blueprintsblueprint_identifieractionsaction_identifier(
...
def put_v1blueprintsblueprint_identifieractionsaction_identifier(
...
def delete_v1blueprintsblueprint_identifieractionsaction_identifier(
    action_identifier: str, blueprint_identifier: str, api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def get_v1actionsaction_identifierpermissions(
...
def patch_v1actionsaction_identifierpermissions(
    action_identifier: str, data: Dict[str, Any], api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def get_v1blueprintsblueprint_identifieractionsaction_identifierpermissions(
    action_identifier: str, blueprint_identifier: str, api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def patch_v1blueprintsblueprint_identifieractionsaction_identifierpermissions(
    action_identifier: str,
    blueprint_identifier: str,
    data: Dict[str, Any],
    api_config_override: Optional[APIConfig] = None,
